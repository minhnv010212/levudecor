<table id="tbslogan" class="tbplugin">
	...
	<tr>
		<td colspan="7">
			...
			<input id="sloganshopinput" class="slider " type="range" name="range-1a" id="sizeslogan" min="0" max="8" value="4" step="0.05" onchange="changeSizeslogan(this);"  data-highlight="true"/>
		</td>
	</tr>
	<tr>
		<td colspan="7">
			<label class="lbplugin"  for="slider-fill">Move (x,y):</label>
			<input id="sloganshop_x" class="slider" type="range" name="range-1a" id="marginslogan_x" min="12" max="52" value="32" step="0.05" onchange="changeMarginslogan_x(this);"  data-highlight="true"/>
			<input id="sloganshop_y" class="slider" type="range" name="range-1a" id="marginslogan" min="15" max="55" value="35" step="0.05" onchange="changeMarginslogan(this);"  data-highlight="true"/>
		</td>
	</tr>
</table>
<script>
